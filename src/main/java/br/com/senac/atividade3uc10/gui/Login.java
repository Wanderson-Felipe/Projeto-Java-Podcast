...
import br.com.senac.atividade3uc10.persistencia.Criptografia;
...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnlogin.setFont(new java.awt.Font("Segoe UI Historic", 0, 14)); // NOI18N
    ...
    private void btnloginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnloginActionPerformed
        ...
        if (usuario != null && usuario.getSenha().equals(senha)) {
            ...
            if (usuario.getTipo().equalsIgnoreCase("administrador")) {
                ...
                cadastroPodcast.botoesOperador();
                listagem.botoesOperador();

            } else {
                JOptionPane.showMessageDialog(null, "Bem-vindo, Usuario " + usuario.getNome());
                cadastroPodcast.botoesUsuario();
                listagem.botoesUsuario();
